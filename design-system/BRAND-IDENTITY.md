...
**Authority.** Clinical evidence leads our work. The system carries authority. Marketing supports it.
...
**Warm.** Authority without warmth is corporate. Restraint without warmth is cold. We are competent and human — but the warmth comes from the writing, not from named personalities.
...
Most brand voice guides say "write so a fifth grader can understand it." We say the opposite for protocol content: **write so a board-certified dermatologist respects it**. Use the technical terms. Cite the studies. Trust the practitioner reader. Plain-language explanations belong on consumer-facing brands. We are B2B. Sophistication is the table stakes.
...
Always verify Pantone against a physical Pantone book before mass production.
...
- **Founders, executives, or team members for public marketing use**
...
- Backgrounds: bone, midnight, or environmental
...
- Faces partially or fully obscured unless explicit face-visible consent
...
8px-based grid: 4, 8, 12, 16, 24, 32, 48, 64, 80, 96, 128, 160px.

### 10.2 Section Rhythm

- Section vertical padding: `py-20` mobile, `py-32` desktop
- Hero: `py-32` mobile, `py-40` desktop
- Section transitions: hard. No fades, no gradients between sections.
...
- **No personal sender names** — emails come from "Precise Aesthetics" (`hello@preciseaesthetics.com`), not from individuals
...
- Avatar: circle monogram dark variant
...
- Never: stock graphics, generic templates, emoji-heavy captions, headshots of team
...
- Hashtags: 3-5 maximum, lowercase
...
When Precise Aesthetics appears alongside another brand:
...
- **Source files:** `/brand-source/` in Google Drive
...
Engage trademark counsel by **May 15, 2026**.
