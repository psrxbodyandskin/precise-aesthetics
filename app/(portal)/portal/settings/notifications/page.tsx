...
export default async function PortalNotificationSettingsPage() {
  ...
  const prefs = await getPreferencesForPractice(practice.id);
    ...
    <PortalShell practiceName={practice.name}>
      <article className="mx-auto max-w-[900px] px-6 pt-12 pb-24 md:px-12 md:pt-16 md:pb-32">
        ...
        <header>
          ...
          >
            Choose which notifications you receive and how. Clinical-safety
